...
{	
	...
	//Direccion del sitio local.
	var $translationDir = "http://localhost/www/MyPortfolio/translator/";
	//Direccion del sitio web.
	//var $translationDir = "http://carlosdominguez.co.cc/translator/";
	
	//the absolute directories where flag images are stored
	//Direccion del sitio local.
	var $flagHomeSmall = "http://localhost/www/MyPortfolio/translator/imgFlags/16px/";
	var $flagHomeLarge = "http://localhost/www/MyPortfolio/translator/imgFlags/32px/";
	//Direccion del sitio web.
	//var $flagHomeSmall = "http://carlosdominguez.co.cc/translator/imgFlags/16px/";
	//var $flagHomeLarge = "http://carlosdominguez.co.cc/translator/imgFlags/32px/";
