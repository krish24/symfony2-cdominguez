Layout = {
   Cfg : {
      ...
      ResizingMain:3,             // User can resize grid main tag
      ...
      PrintCols:2,                // Let a user to choose which columns will be printed and shows print options
      ExportCols:2,                // Let a user to choose which columns will be exported and shows export options
      ExportPDFCols:2             // Let a user to choose which columns will be printed to PDF and shows print PDF options
      },
   ...
   LeftCols : [
      ...
      { Name:'A', RelWidth:'100', MinWidth:'250', Type:'Text', ToolTip:'1', CanFilter:'2', SearchNames:'Product name,Product,Order name,Order' } // Product / Order name
      ],
   Cols: [
